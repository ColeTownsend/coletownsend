...
[Nomad](http://nomad.cool) is a command line tool that lets you install packages of code on your Ardunio. In three commands, you can get your Arduino up and running within minutes using the most popular packages on the internet. You can also easily package and share your own setup.

## Logo

For this project, I created both a logo and landing page for the service. The logo is an assymetric tent with bright red hues with a deep purple stroke. It's meant to evoke the hunter-gatherer lifestyle of its namesake: fire, warmth, safety, mobility, and flexibility.
