...
Nomad package manager for Arduino. In three commands, you can get your device up and running within minutes using the most popular libraries on the internet. You can also easily package and share your own setup.
...
<br>
<figure class="web">
  <img class="land-img" src="{{ site.url }}/images/inline/nomad-desktop.png">
</figure>
